...
def main(page: ft.Page):
    ...
    def run_neuron():
        ...
        if superAI.for_front(input_text_fromFront) == 0:  # Correctly reference the function from superAI
            detailed_answer.controls.append(ft.Row([
                ft.Text("neuron: ", size=text_size, color='white'),
                ft.Text("негативный", size=text_size, color='red')
            ]))
            nets_votes -= 1
        else:
            detailed_answer.controls.append(ft.Row([
                ft.Text("neuron: ", size=text_size, color='white'),
                ft.Text("положительный", size=text_size, color='green')
            ]))
            nets_votes += 1
        page.update()
    ...
    def run_FunctionalAPI():
        ...
        if fAPI_test.for_front_Funcstional(input_text_fromFront) == 0:
            detailed_answer.controls.append(ft.Row([
                ft.Text("FunctionalAPI: ", size=text_size, color='white'),
                ft.Text("негативный", size=text_size, color='red')
            ]))
            nets_votes -= 1
        else:
    ...
    def run_FastText():
        ...
        if FT_test.FastText(input_text_fromFront) == 0:
            detailed_answer.controls.append(ft.Row([
                ft.Text("FastText: ", size=text_size, color='white'),
                ft.Text("негативный", size=text_size, color='red')
            ]))
            nets_votes -= 1
        else:
    ...
    def run_Sequential():
        ...
        if Sequentinal_model.for_front_Sequentinal(input_text_fromFront) == 0:
            detailed_answer.controls.append(ft.Row([
                ft.Text("Sequential: ", size=text_size, color='white'),
                ft.Text("негативный", size=text_size, color='red')
            ]))
            nets_votes -= 1
        else:
    ...
    def run_Word2Vec():
        ...
        if W2V_test.W2V_test(input_text_fromFront) == 0:
            detailed_answer.controls.append(ft.Row([
                ft.Text("Word2Vec: ", size=text_size, color='white'),
                ft.Text("негативный", size=text_size, color='red')
            ]))
            nets_votes -= 1
        else:
